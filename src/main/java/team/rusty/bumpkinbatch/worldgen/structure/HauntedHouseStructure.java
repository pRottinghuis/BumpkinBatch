...
public class HauntedHouseStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public HauntedHouseStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, HauntedHouseStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            BumpkinBatch.LOGGER.log(Level.DEBUG, "Haunted House at {}", blockpos);
        }
